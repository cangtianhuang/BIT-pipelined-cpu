...
HD_PWD='E:/Xilinx/MyVivadoStudy/BIT_pipelined_cpu/BIT_pipelined_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pressINC_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_pressINC_control.tcl
