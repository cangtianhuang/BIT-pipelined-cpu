...
HD_PWD='E:/Xilinx/MyVivadoStudy/BIT_pipelined_cpu/BIT_pipelined_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pressINC_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_pressINC_control.tcl -notrace
